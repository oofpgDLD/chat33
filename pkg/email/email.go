...
import (
	...
	. "github.com/33cn/chat33/pkg/email/model"
	http_tools "github.com/33cn/chat33/pkg/http"
	"github.com/revel/log15"
)

func Send(serviceUrl, codeType, email, msg, ticket, businessId string) (*SendResult, error) {
...
func ValidateCode(serviceUrl, codeType, email, code string) error {
	values := map[string]string{
		"t":        "email",
		"codetype": codeType,
		"code":     code,
